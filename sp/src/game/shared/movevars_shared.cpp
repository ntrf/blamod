...
ConVar	sv_maxvelocity	( "sv_maxvelocity","5000", FCVAR_REPLICATED | FCVAR_DEVELOPMENTONLY, "Maximum speed any ballistically moving object is allowed to attain per axis." );
ConVar	sv_fallvelocity ("sv_fallvelocity", "0", FCVAR_REPLICATED | FCVAR_DEVELOPMENTONLY, "Maximum speed any object is allowed to fall with.\nSet to 0 to use sv_maxvelocity value");
