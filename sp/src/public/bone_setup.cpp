...
//-----------------------------------------------------------------------------
void __cdecl Studio_RunBoneFlexDrivers(float *pflFlexControllerWeights, const CStudioHdr *pStudioHdr, const Vector *pvPositions, const matrix3x4_t *pBoneToWorld, const matrix3x4_t &mRootToWorld)
{
#if 0
